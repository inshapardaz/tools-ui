...
import { Alert, Button, Divider, List, LoadingOverlay, Stack, Tabs, Text, TextInput, Title } from "@mantine/core";
        ...
        <Tabs defaultValue="simple">
          ...
          <Tabs.Panel value="advanced">
            ...
            <Stack>
              ...
              <List>
                <List.Item>Navigate to library website <a href="https://www.chughtailibrary.com/" target="_blank">https://www.chughtailibrary.com/</a> in your browser.</List.Item>
                <List.Item>Open the book page that you want to download. If you can see the "Please click here to sign-in" button, instead of book pages, please click it. </List.Item>
                ...
                <List.Item>It is important that you do not close the library website while download is in progress as closing website would render the session id invalid and download may not work properly.</List.Item>
              </List>
